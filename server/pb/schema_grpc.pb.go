...
const (
	Say_Hello_FullMethodName = "/proto.Say/Hello"
)
...
type SayClient interface {
	Hello(ctx context.Context, in *Mess, opts ...grpc.CallOption) (*Mess, error)
}
...
func (c *sayClient) Hello(ctx context.Context, in *Mess, opts ...grpc.CallOption) (*Mess, error) {
	out := new(Mess)
...
type SayServer interface {
	Hello(context.Context, *Mess) (*Mess, error)
...
func (UnimplementedSayServer) Hello(context.Context, *Mess) (*Mess, error) {
...
func _Say_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayServer).Hello(ctx, req.(*Mess))
	}
